    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!File.Exists(textFilePath)) // First iteration will always fail in order to prompt the user input the path to the text file
            {
                ...
                {
                    if (FileTypeChecker.IsTextFile(textFilePath))
                    {
                        ...
                        else
                        {
                            ...
                            {
                                Console.WriteLine("Number of person names value must be a positive integer number. \nNothing was generated.");
                            }
                            else if (!isnumberOfNamePartsSuccess)
                            {
                                Console.WriteLine("Number of name parts value must be a positive integer number. \nNothing was generated.");
                            }
                            else if (numberOfNameParts <= 0)
                            {
                                Console.WriteLine("The name can not consist with 0 or negative number of parts. \nNothing was generated.");
                            }
                            else
                            {
                                Console.WriteLine("You provided number of names to be generated 0 or below the 0. \nNothing was generated.");
                            }
                        }
                    }
                    else
                    {
                        Console.WriteLine("The file provided above is not a text file. \nNothing was generated.");
                    }
                ...
                {
                    Console.WriteLine($"The program was unable to find the file by the provided path: \"{textFilePath}\". \nPlease double check the path and try again...");
                }
            };
